...
#> Warning in left_join(transcripts, select(actors, speaker_std, Type, Position), : Detected an unexpected many-to-many relationship between `x` and `y`.
#> ℹ Row 700 of `x` matches multiple rows in `y`.
...
#>  4 Judiciary         3477
#>  5 Media             3314
#>  6 Businessperson    1728
#>  7 Elected Official  1304
#>  8 Foreign           1246
#>  9 Illict              88
#> 10 Illicit             80
```
