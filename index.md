...
1990 to 2000. This package provides user-friendly access to a large
digital archive of *Vladivideo* transcripts and metadata, including data
about 125 individual speakers in the files and 15 topics of importance
...
User Guide](https://jessietrudeau.com/BribeR/articles/using_briber.html)
...
Ministry of Culture’s Place of Memory, Tolerance, and Social
Inclusion).  
...
This research was supported by Syracuse University’s Open Source Program
Office (OSPO) and the Sloan Foundation.
...
> Analyzing Vladivideos Transcript Data*. R package version 0.1.0.
