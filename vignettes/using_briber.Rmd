...
There are 108 speaker IDs that `get_transcript_id()` can filter on. The `actors` dataset lists 118 individuals in total; those with `is_speaker == 1` are the ones recorded speaking in the corpus.
