...
| `is_speaker`                 | integer   | 1 if the individual has at least one speech turn in the corpus, 0 if they are named in the archive but never recorded speaking. Only those with `is_speaker == 1` can be filtered with `get_transcript_id()`  |
...
[^2]: The party codes match `v2pashname`, the party abbreviation variable for Peru in the V-Party dataset: `NM`, `PAP`, `RN`, `PP`, `PPC`, `FIM` and `AP`.
