...
::: {#quote-esp .quote-version style="display: none;"}
```         
...
function showQuote(lang) {
  document.getElementById("quote-eng").style.display = lang === "eng" ? "block" : "none";
  document.getElementById("quote-esp").style.display = lang === "esp" ? "block" : "none";
}
</script>
```
