...
See, for example, this exchange about consolidating power in the judicial branch between Montesinos and Alipio Montes de Oca, Supreme Court Judge (Transcript id XX[^1], May 3, 1998). This exchange is printed in English with Spanish original text in italics below.[^2]

[^1]: Originally numbered Transcript 888 by the Congress of Peru.

[^2]: All transcripts in the database are not translated from their original Spanish version. This is translated just as an example for readability in the vignette. 
...
Each transcript is hand-coded[^2] and classified by topic(s). The 15
topics include:
