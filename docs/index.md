...
individual speakers in the files and 15 expert-coded topics of importance during the
Fujimori presidency.

<p align="center">
  <img src="reference/figures/network_viz.png" width="60%"> 
</p>

<p align="center">Speakers recorded in the *Vladivideo* files, with Montesinos in the center. 
See [Network Visualization](https://jessietrudeau.com/BribeR/articles/transcript_network_app.html)
for more details.</p>
...
conversations involving **media manipulation** would run the following lines of
code:
